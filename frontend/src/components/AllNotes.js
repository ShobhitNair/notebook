...
const AllNotes = () => {
  ...
  return (
    <div>
      ...
      <div className="card bg-info m-2" key={note._id} style={{width: "18rem"}}>
        <div className="card-body">
          ...
          <button type="button" className="btn btn-danger" onClick={()=>handleDeleteNote(note._id)}>Delete</button>
